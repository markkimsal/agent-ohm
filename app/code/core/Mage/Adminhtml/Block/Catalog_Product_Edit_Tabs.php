...
class Mage_Adminhtml_Block_Catalog_Product_Edit_Tabs extends Mage_Adminhtml_Block_Widget_Tabs
{
    ...
    protected function _prepareLayout()
    {
        ...
        if ($setId) {
            ...
            $this->addTab('inventory', array(
                'label'     => AO::helper('catalog')->__('Inventory'),
            ...
            if ($alertPriceAllow || $alertStockAllow) {
                $this->addTab('productalert', array(
                    'label'     => AO::helper('catalog')->__('Product Alerts'),
            ...
            if( $this->getRequest()->getParam('id', false) ) {
                $this->addTab('reviews', array(
                    'label' => AO::helper('catalog')->__('Product Reviews'),
                    'url'   => $this->getUrl('*/*/reviews', array('_current' => true)),
                    'class' => 'ajax',
                ));

                $this->addTab('tags', array(
                    'label'     => AO::helper('catalog')->__('Product Tags'),
                    'url'   => $this->getUrl('*/*/tagGrid', array('_current' => true)),
                    'class' => 'ajax',
                ));

                $this->addTab('customers_tags', array(
                    'label'     => AO::helper('catalog')->__('Customers Tagged Product'),
            ...
            if ($this->getProduct()->getTypeId() != Mage_Catalog_Model_Product_Type::TYPE_GROUPED) {
                $this->addTab('customer_options', array(
                    'label' => AO::helper('catalog')->__('Custom Options'),
            ...
            $this->addTab('set', array(
                'label'     => AO::helper('catalog')->__('Settings'),
    ...
    {
        if (is_null(AO::helper('adminhtml/catalog')->getAttributeTabBlock())) {
            return $this->_attributeTabBlock;
        }
        return AO::helper('adminhtml/catalog')->getAttributeTabBlock();
    }
