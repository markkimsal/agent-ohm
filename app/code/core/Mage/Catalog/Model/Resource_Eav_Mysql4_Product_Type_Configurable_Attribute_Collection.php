    ...
    extends Mage_Core_Model_Mysql4_Collection_Abstract
{
    ...
    {
        parent::_afterLoad();
        if (VPROF) Varien_Profiler::start('TTT1:'.__METHOD__);
        $this->_addProductAttributes();
        if (VPROF) Varien_Profiler::stop('TTT1:'.__METHOD__);
        if (VPROF) Varien_Profiler::start('TTT2:'.__METHOD__);
        $this->_addAssociatedProductFilters();
        if (VPROF) Varien_Profiler::stop('TTT2:'.__METHOD__);
        if (VPROF) Varien_Profiler::start('TTT3:'.__METHOD__);
        $this->_loadLabels();
        if (VPROF) Varien_Profiler::stop('TTT3:'.__METHOD__);
        if (VPROF) Varien_Profiler::start('TTT4:'.__METHOD__);
        $this->_loadPrices();
        if (VPROF) Varien_Profiler::stop('TTT4:'.__METHOD__);
        return $this;
    }
