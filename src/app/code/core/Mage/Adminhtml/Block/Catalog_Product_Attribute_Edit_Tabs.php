...
class Mage_Adminhtml_Block_Catalog_Product_Attribute_Edit_Tabs extends Mage_Adminhtml_Block_Widget_Tabs
{
    ...
    public function __construct()
    {
        ...
        $this->setTitle(AO::helper('catalog')->__('Attribute Information'));
    }

    protected function _beforeToHtml()
    {
        $this->addTab('main', array(
            'label'     => AO::helper('catalog')->__('Properties'),
            'title'     => AO::helper('catalog')->__('Properties'),
        ...
        $this->addTab('labels', array(
            'label'     => AO::helper('catalog')->__('Manage Label / Options'),
            'title'     => AO::helper('catalog')->__('Manage Label / Options'),
        ...
        /*if ('select' == $model->getFrontendInput()) {
            $this->addTab('options_section', array(
                'label'     => AO::helper('catalog')->__('Options Control'),
                'title'     => AO::helper('catalog')->__('Options Control'),
                'content'   => $this->getLayout()->createBlock('adminhtml/catalog_product_attribute_edit_tab_options')->toHtml(),
            ));
        }*/
