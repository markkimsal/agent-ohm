...
class Mage_Adminhtml_Block_Customer_Edit_Tabs extends Mage_Adminhtml_Block_Widget_Tabs
{
    ...
    public function __construct()
    {
        ...
        $this->setTitle(AO::helper('customer')->__('Customer Information'));
    }
    ...
    protected function _beforeToHtml()
    {
        if (AO::registry('current_customer')->getId()) {
            $this->addTab('view', array(
                'label'     => AO::helper('customer')->__('Customer View'),
        ...
        $this->addTab('account', array(
            'label'     => AO::helper('customer')->__('Account Information'),
            'content'   => $this->getLayout()->createBlock('adminhtml/customer_edit_tab_account')->initForm()->toHtml(),
            'active'    => AO::registry('current_customer')->getId() ? false : true
        ));

        $this->addTab('addresses', array(
            'label'     => AO::helper('customer')->__('Addresses'),
        ...
        if (VPROF) Varien_Profiler::stop('customer/tabs');
