...
class Mage_Adminhtml_Block_Catalog_Product_Attribute_Edit_Tab_Front extends Mage_Adminhtml_Block_Widget_Form
{
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset = $form->addFieldset('base_fieldset', array('legend'=>AO::helper('catalog')->__('Frontend Properties')));
        ...
        $fieldset->addField('is_filterable', 'select', array(
            'name' => 'is_filterable',
            'label' => AO::helper('catalog')->__("Use In Layered Navigation<br/>(Can be used only with catalog input type 'Dropdown')"),
            'title' => AO::helper('catalog')->__('Can be used only with catalog input type Dropdown'),
            'values' => array(
...
//        if ($model->getIsUserDefined() || !$model->getId()) {
            $fieldset->addField('is_visible_on_front', 'select', array(
                ...
                'label' => AO::helper('catalog')->__('Visible on Catalog Pages on Front-end'),
                'title' => AO::helper('catalog')->__('Visible on Catalog Pages on Front-end'),
                'values' => $yesno,
            ));
//        }
