...
class Mage_Adminhtml_Block_Rating_Edit_Tabs extends Mage_Adminhtml_Block_Widget_Tabs
{
    ...
    public function __construct()
    {
        ...
        $this->setTitle(AO::helper('rating')->__('Rating Information'));
    }

    protected function _beforeToHtml()
    {
        $this->addTab('form_section', array(
            'label'     => AO::helper('rating')->__('Rating Information'),
            'title'     => AO::helper('rating')->__('Rating Information'),
            'content'   => $this->getLayout()->createBlock('adminhtml/rating_edit_tab_form')->toHtml(),
        ))
        ;
/*
        $this->addTab('answers_section', array(
                'label'     => AO::helper('rating')->__('Rating Options'),
                'title'     => AO::helper('rating')->__('Rating Options'),
